...
export default function IletisimPage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--LAC-bg)', minHeight: '100vh', paddingBottom: '4rem', fontFamily: 'var(--font-inter)' }}>
      ...
      <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '1rem 2rem', borderBottom: '1px solid var(--LAC-border)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', fontSize: '0.85rem', color: 'var(--LAC-text-muted)' }}>
          ...
          <span style={{ color: 'var(--LAC-orange)' }}>Departman İletişimi</span>
        </div>
      </div>

      <div style={{ maxWidth: '1200px', margin: '3rem auto', padding: '0 2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <h1 style={{ fontSize: '2.8rem', fontWeight: 900, color: 'var(--LAC-blue-dark)', margin: '0 0 1rem', letterSpacing: '-0.02em' }}>
            DEPARTMAN İLETİŞİMİ
          </h1>
          <div style={{ width: '60px', height: '4px', backgroundColor: 'var(--LAC-orange)', margin: '0 auto 1.5rem' }}></div>
          <p style={{ fontSize: '1.1rem', color: 'var(--LAC-text-muted)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '2rem', border: '1px solid var(--LAC-border)', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '1.5rem' }}>
                <div style={{ width: '50px', height: '50px', backgroundColor: 'rgba(232, 79, 42, 0.1)', color: 'var(--LAC-orange)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem' }}>
                  <i className="fa-solid fa-building-shield"></i>
                </div>
                <div>
                  <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--LAC-blue-dark)' }}>Merkez Karargah (HQ)</h3>
                  <div style={{ fontSize: '0.85rem', color: 'var(--LAC-text-muted)', marginTop: '4px' }}>Los Angeles C.P.D.</div>
                </div>
              </div>
              <p style={{ fontSize: '0.9rem', color: 'var(--LAC-text-dark)', lineHeight: 1.6, margin: 0 }}>
            ...
            <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '2rem', border: '1px solid var(--LAC-border)', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
               <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '1.5rem' }}>
                <div style={{ width: '50px', height: '50px', backgroundColor: 'rgba(4, 22, 50, 0.1)', color: 'var(--LAC-blue-dark)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem' }}>
                  <i className="fa-solid fa-phone-volume"></i>
                </div>
                <div>
                  <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--LAC-blue-dark)' }}>Önemli Numaralar</h3>
                </div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', fontSize: '0.9rem', color: 'var(--LAC-text-dark)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid var(--bg-tertiary)', paddingBottom: '0.5rem' }}>
                  <span style={{ fontWeight: 600 }}>Acil Durum:</span> <span style={{ color: 'var(--LAC-orange)', fontWeight: 800 }}>911</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid var(--bg-tertiary)', paddingBottom: '0.5rem' }}>
                  <span style={{ fontWeight: 600 }}>Acil Olmayan İhbar:</span> <span>1-877-ASK-LAC</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid var(--bg-tertiary)', paddingBottom: '0.5rem' }}>
          ...
          {/* ── RIGHT: CONTACT FORM ── */}
          <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '3rem', border: '1px solid var(--LAC-border)', borderRadius: '8px', boxShadow: '0 10px 25px rgba(0,0,0,0.03)' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--LAC-blue-dark)', margin: '0 0 0.5rem' }}>Çevrimiçi İletişim Formu</h2>
            <p style={{ fontSize: '0.9rem', color: 'var(--LAC-text-muted)', marginBottom: '2rem' }}>Acil olmayan konulardaki sorularınız veya bilgi talepleriniz için lütfen aşağıdaki formu eksiksiz doldurun. Talepleriniz 48 iş saati içerisinde değerlendirilecektir.</p>
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--LAC-text-dark)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Ad Soyad <span style={{color:'var(--LAC-orange)'}}>*</span></label>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--LAC-text-dark)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>E-Posta Adresi <span style={{color:'var(--LAC-orange)'}}>*</span></label>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--LAC-text-dark)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Konu <span style={{color:'var(--LAC-orange)'}}>*</span></label>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--LAC-text-dark)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Mesajınız <span style={{color:'var(--LAC-orange)'}}>*</span></label>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '0.5rem' }}>
                  <button type="submit" disabled={status === 'loading'} style={{
                    padding: '1rem 2rem', backgroundColor: 'var(--LAC-blue-dark)', color: 'var(--bg-primary)',
