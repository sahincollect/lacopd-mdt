...
const applicationTypes = [
  {
    ...
    bg: "var(--LAC-blue-dark)",
    hoverBg: "var(--LAC-blue)",
    ...
    >
      ...
      <div style={{ backgroundColor: 'var(--bg-tertiary)', padding: '1rem 2rem', borderBottom: '1px solid var(--LAC-border)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', fontSize: '0.85rem', color: 'var(--LAC-text-muted)' }}>
          ...
          <span style={{ color: 'var(--LAC-orange)' }}>Başvurular</span>
        </div>
      </div>
      ...
      >
        <div>
          ...
          >
            ...
            <span style={{ fontSize: "0.85rem", color: "var(--LAC-blue-dark)", fontWeight: 800, letterSpacing: "0.05em", textTransform: "uppercase" }}>
          ...
          {applicationTypes.map((app, i) => (
            ...
            >
              ...
              <div style={{ padding: "2.5rem" }}>
                ...
                <div style={{ fontSize: "0.75rem", color: "var(--LAC-text-muted)", letterSpacing: "0.1em", fontWeight: 700, textTransform: "uppercase", marginBottom: "0.5rem" }}>
                  {app.subtitle}
                </div>
                <h2 style={{ fontSize: "1.5rem", fontWeight: 800, color: "var(--LAC-blue-dark)", margin: "0 0 1rem", letterSpacing: "-0.01em" }}>{app.title}</h2>
                <p style={{ fontSize: "0.95rem", color: "var(--LAC-text-dark)", lineHeight: 1.6, margin: "0 0 2rem" }}>{app.description}</p>

                {/* Requirements */}
                <div style={{ marginBottom: "2rem" }}>
                  <div style={{ fontSize: "0.8rem", color: "var(--LAC-blue-dark)", letterSpacing: "0.05em", fontWeight: 800, textTransform: "uppercase", marginBottom: "1rem", borderBottom: "1px solid var(--LAC-border)", paddingBottom: "0.5rem" }}>
                    Gereksinimler
                  </div>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                    {app.requirements.map((req, ri) => (
                      <li key={ri} style={{ display: "flex", alignItems: "center", gap: "0.8rem", fontSize: "0.9rem", color: "var(--LAC-text-dark)", fontWeight: 500 }}>
                ...
                <Link
                  ...
                  style={{
                    ...
                    border: 'none',
                    color: app.bg === 'var(--bg-tertiary)' ? 'var(--LAC-text-dark)' : 'white',
                    textDecoration: "none",
                    fontWeight: 800,
                    fontSize: "0.9rem",
