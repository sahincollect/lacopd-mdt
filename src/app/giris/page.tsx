...
export default function GirisPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.message || 'Sicil numaras� veya �ifre hatal�.');
      }
    } catch {
      setError('Sunucuya ba�lan�lamad�. L�tfen tekrar deneyin.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else setRegError(data.message || 'Ba�vuru kaydedilemedi.');
    } catch {
      setRegError('Ba�lant� hatas�. L�tfen tekrar deneyin.');
    } finally {
      setRegLoading(false);
    }
  };
          ...
          <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', height: '100%', padding: '2.5rem 3rem' }}>
            ...
            <div style={{ marginTop: 'auto', marginBottom: 'auto', paddingTop: '2rem' }}>
              ...
              <p style={{
                ...
                Yetkili personele �zel komuta, dispe� ve koordinasyon platformu. Eri�im yaln�zca aktif badge numaras� ile m�mk�nd�r.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', gap: '20px', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.12)' }}>
              {[
                { icon: 'fa-lock', text: 'AES-256 �ifreli' },
                { icon: 'fa-shield-check', text: 'TLS 1.3' },
                { icon: 'fa-user-shield', text: '�ki Katmanl� G�venlik' },
              ].map((item, i) => (
                ...
                <div className="form-fade">
                  <div style={{ marginBottom: '1.75rem' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                      MDT sistemine eri�mek i�in giri� yap�n.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
                    <div>
                      <label style={labelStyle}>Sicil / Rozet Numaras� <span style={{ color: 'var(--accent-secondary)' }}>*</span></label>
                      <input
                        className="LAC-input"
                        type="text"
                        placeholder="�rn: 1222 veya 04-1234"
                        value={badge}
                    ...
                    <div>
                      <label style={labelStyle}>G�venlik �ifresi <span style={{ color: 'var(--accent-secondary)' }}>*</span></label>
                      <input
                        className="LAC-input"
                        type="password"
                        placeholder="��������"
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <label htmlFor="remember" style={{ fontSize: '0.82rem', color: 'var(--text-muted)', cursor: 'pointer', userSelect: 'none' }}>
                        Oturumu 24 saat boyunca a��k tut
                      </label>
                    </div>
                    ...
                    >
                      {loading
                        ? <><i className="fa-solid fa-circle-notch fa-spin"></i> Do�rulan�yor...</>
                        : <><i className="fa-solid fa-right-to-bracket"></i> S�STEME G�R�� YAP</>
                      }
                    </button>
                  </form>
                ...
                <div className="form-fade" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>
                  {regSuccess ? (
                    <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                      ...
                      <h3 style={{ margin: '0 0 8px', color: 'var(--accent-primary)', fontWeight: 800, fontSize: '1.3rem' }}>Ba�vuru Al�nd�!</h3>
                      <p style={{ margin: '0 0 1.5rem', color: 'var(--text-muted)', fontSize: '0.88rem', lineHeight: 1.6 }}>
                        Yetki talebiniz y�netime iletildi.<br />Onayland�ktan sonra giri� yapabilirsiniz.
                      </p>
                      <button
                    ...
                    <>
                      <div style={{ marginBottom: '1.75rem' }}>
                        ...
                        <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                          MDT eri�imi i�in bilgilerinizi eksiksiz doldurun.
                        </p>
                      </div>
                      ...
                      <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                          ...
                          <div>
                            <label style={labelStyle}>�sim Soyisim <span style={{ color: 'var(--accent-secondary)' }}>*</span></label>
                        ...
                        <div>
                          <label style={labelStyle}>R�tbe <span style={{ color: 'var(--accent-secondary)' }}>*</span></label>
                        ...
                        <div>
                          <label style={labelStyle}>�ifre <span style={{ color: 'var(--accent-secondary)' }}>*</span></label>
                        ...
                        >
                          {regLoading
                            ? <><i className="fa-solid fa-circle-notch fa-spin"></i> G�nderiliyor...</>
                            : <><i className="fa-solid fa-user-plus"></i> BA�VURUYU TAMAMLA</>
                          }
                        </button>
                      </form>
                    </>
